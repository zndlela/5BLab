...
% 2013.04.15 inserted [noitemsep] for enumerate env to reduce spacing
%--------------------------------------------------------------------------
...
\begin{center}
	\includegraphics[scale=0.4]{5bgraf/rhrulecoil}
	\mfcaption{Right hand rule for magnetic fields}
	\label{f:rhrulecoil}
\end{center}

\paragraph{Short problem}
Suppose the current in coil 1 is increasing in \reffig{f:fig_12}.  Explain the direction of the current induced in coil 2 using Faraday's law, Lenz's law, and the ``Right Hand Rule'' for magnetic fields.  You may be asked to turn in your explanation at the beginning of class as a short preparatory quiz.
