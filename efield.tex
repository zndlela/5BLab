...
\begin{enumerate}
	 ...
	 \item Calculate the value of the electric field between three (3) different potential pair values inside the plates and at one (1) potential pair value outside the plates, in the ``fringe'' area using \refeqn{e:EandV}. For example, inside plates:\\ 
